...
#Where is this adaptIntro coming from
...
#i=1
#D_All_2000_2<-subset(D_All_2000,chr==adaptIntro$csome[i]&windowStart<adaptIntro$stop[i]&windowEnd>adaptIntro$start[i])
...
pdf("C:/Users/rmohn/Desktop/10_Analysis/120_Ad_Int/AdaptWins2000_260205.pdf",height=6.5,width=9)
...
for(i in 1:length(adaptIntro$csome)){
  ...
  if(length(GEA_D$p_alb)>0){
    ...
    GEA_D$sigDGEA[GEA_D$p_lob<0.0000936|GEA_D$p_ste<0.0000936|GEA_D$p_mue<0.0000936|GEA_D$p_alb<0.0000936]<-"sig" #Is this correct for p_alba
    #
...
write.table(GEA_INT_DATABASE,file="C:/Users/rmohn/Desktop/10_Analysis/120_Ad_Int/Ad_Int_Database_samp_260901_alpha.txt",row.names = FALSE, quote = FALSE, sep="\t")
...
#   
#   #Subset the Dstats
#   D_SS<-subset(D_All_2000,chr==adaptIntro$csome[i]&windowMid>adaptIntro$pos[i]-50000&windowMid<adaptIntro$pos[i]+50000)
